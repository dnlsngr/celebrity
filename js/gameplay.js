...
//var nameList = []//Dependent on included file
...
function showScoreboard(){
	...
	*/
	document.getElementById('gameFrame').innerHTML = "../static/scoreboard.html";
...
function startGame(){
	...
	document.getElementById('body').innerHTML = document.open("../static/header.html");
	//showScoreboard();
}

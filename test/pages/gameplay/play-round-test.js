...
describe('PlayRound', () => {
  it('should render PlayRound', () => {
    ...
    const wrapper = shallow(<PlayRound roundInfo={roundInfo} turnInfo={{}}/>)
  ...
  it('should call nameCorrect when correct button clicked', () => {
    ...
    const wrapper = mount(
      <PlayRound roundInfo={{}} turnInfo={{}} nameCorrect={nameCorrectStub}/>)
  ...
  it('should call nameSkipped when correct button clicked', () => {
    ...
    const wrapper = mount(
      <PlayRound roundInfo={{}} turnInfo={{}} nameSkipped={nameSkippedStub}/>)
  ...
  it('should call illegalClue when correct button clicked', () => {
    ...
    const wrapper = mount(
      <PlayRound roundInfo={{}} turnInfo={{}} illegalClue={illegalClueStub}/>)

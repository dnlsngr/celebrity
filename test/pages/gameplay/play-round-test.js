...
describe("PlayRound", () => {
  ...
  it("should render PlayRound", () => {
    const wrapper = shallow(
      <PlayRound roundInfo={roundInfo} turnInfo={turnInfo} />
    );
  ...
  it("should render an button to end turn if no currentName is specified", () => {
    ...
    const wrapper = shallow(
      <PlayRound roundInfo={roundInfo} turnInfo={turnInfoNoCurrentName} />
    );
